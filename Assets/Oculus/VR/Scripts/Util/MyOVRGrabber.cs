...
/// <summary>
/// Allows grabbing and throwing of objects with the MyOVRGrabbable component on them.
/// </summary>
[RequireComponent(typeof(Rigidbody))]
public class MyOVRGrabber : MonoBehaviour
{
	...
	protected MyOVRGrabbable m_grabbedObj = null;
    protected Vector3 m_grabbedObjectPosOff;
    protected Quaternion m_grabbedObjectRotOff;
	protected Dictionary<MyOVRGrabbable, int> m_grabCandidates = new Dictionary<MyOVRGrabbable, int>();
    ...
    /// </summary>
    public MyOVRGrabbable grabbedObject
    {
        get { return m_grabbedObj; }
    }

	public void ForceRelease(MyOVRGrabbable grabbable)
    {
        bool canRelease = (
            (m_grabbedObj != null) &&
    ...
    void OnTriggerEnter(Collider otherCollider)
    {
		...
		MyOVRGrabbable grabbable = otherCollider.GetComponent<MyOVRGrabbable>() ?? otherCollider.GetComponentInParent<MyOVRGrabbable>();
    ...
    protected virtual void GrabBegin()
    {
		...
		MyOVRGrabbable closestGrabbable = null;
        Collider closestGrabbableCollider = null;

        // Iterate grab candidates and find the closest grabbable candidate
		foreach (MyOVRGrabbable grabbable in m_grabCandidates.Keys)
        {
	...
	protected virtual void OffhandGrabbed(MyOVRGrabbable grabbable)
    {
